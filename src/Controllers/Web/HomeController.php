...
class HomeController extends Controller
{
    public function index(Request $request)
    {
       ...
       $Contenttext = NewsModel::select('contentvi', 'numb')
            ->where('type', 'Content')
            ->whereRaw("FIND_IN_SET(?,status)", ['hienthi'])
            ->whereIn('numb', [1, 2])
            ->orderBy('id', 'desc')
        ...
        return View::share('com', 'trang-chu')->view('home.index', compact('slider_m', 'proFlashsale', 'newsHome1', 'feedback', 'quangcao', 'listProductNB1', 'slider', 'productNB', 'listProductNB', 'newsHome', 'Contenttext'));
    }
